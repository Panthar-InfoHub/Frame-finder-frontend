...
const ToricPrescription = ({ save, setSave }) => {
  ...
  return (
    <>
      {/* <div className="text-2xl text-center">
        Fill in your Prescription Details for Toric Lenses
      </div> */}
      <div className="grid grid-cols-3 w-full h-[80%] border-2 rounded-4xl overflow-hidden">
        ...
        <div className="text-xl flex items-center pl-3 border-1">Add Power</div>
        <div className="relative flex items-center justify-center gap-1 border-1">
          {error.power_od && (
            <div className="block absolute bottom-[1px] left-1 text-red-500 text-[11px]">
              value must lie between -20 and 20
        ...
        <div className="text-xl flex items-center pl-3 border-1">Axis</div>
        <div className="relative px-2 flex items-center justify-center gap-1 border-1">
          {error.axis_od && (
            <div className="block absolute bottom-[1px] left-1 text-red-500 text-[11px]">
        ...
        <div className="relative px-6 cursor-pointer active:bg-green-100 flex col-span-3 justify-between items-center gap-1 border-1" onClick={handleInput}>
          <div className="text-xl">Upload Prescription</div>
          <div className=""><img src={Arrow} className="rotate-[-90deg]"/></div>
