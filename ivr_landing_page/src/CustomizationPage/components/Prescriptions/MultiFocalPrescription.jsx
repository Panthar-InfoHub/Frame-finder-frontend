        ...
        <div className="relative flex items-center justify-center gap-1 border-1">
          ...
          <div className="flex items-center justify-center gap-1 w-4/5 h-[35%] min-h-[25px] max-h-[55px]">
            <input
              ...
              className="flex-[6] h-full text-xl p-1 outline-none border-b-3 focus:border-b-green-300 appearance-none  [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
            />
            ...
            <div className="h-full flex-[1] max-[1000px]:hidden flex flex-col justify-between items-center">
              <div
                ...
                className="w-full h-[45%] min-h-[9px] p-[10%] leading-none hover:bg-blue-100 rounded-t cursor-pointer"
              >
              ...
              <div
                ...
                className="w-full h-[45%] min-h-[9px] p-[10%] leading-none hover:bg-blue-100 rounded-b cursor-pointer"
              >
